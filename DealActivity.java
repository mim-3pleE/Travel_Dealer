...
public class DealActivity extends AppCompatActivity {
    public static final int REQUEST_PICTURE_CODE = 20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button imageLoader = findViewById(R.id.btnImage);
        imageLoader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent1.createChooser(intent1,
                        "Insert Picture"), REQUEST_PICTURE_CODE);
            }
        });
    }
    ...
    private void showImage(String url) {
        if (url != null && url.isEmpty() == false) {
            ...
            Picasso.get()
                    ...
                    .centerCrop()
                    .placeholder(android.R.drawable.editbox_dropdown_light_frame)
                    .into(imageView);
        }
    }
